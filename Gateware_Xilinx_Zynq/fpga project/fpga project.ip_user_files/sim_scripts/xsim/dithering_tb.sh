...
#
# Script generated by Vivado on Mon May 25 08:00:48 +0200 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dithering_tb.sh
...
#
# Usage        : dithering_tb.sh
#                dithering_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dithering_tb.sh [-rerun]
#                dithering_tb.sh [-reset_run]
#                dithering_tb.sh [-clean]
#                dithering_tb.sh [-reset_log]
#                dithering_tb.sh [-help]
#
...
# script info
echo -e "dithering_tb.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dithering_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xilinx_vip -L xpm -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot dithering_tb xil_defaultlib.dithering_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dithering_tb -key {Behavioral:sim_1:Functional:dithering_tb} -tclbatch cmd.tcl -protoinst "protoinst_files/Processing_System.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dithering_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dithering_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dithering_tb.sh [-help]\n\
Usage: dithering_tb.sh [-step]\n\
Usage: dithering_tb.sh [-lib_map_path]\n\
Usage: dithering_tb.sh [-rerun]\n\
Usage: dithering_tb.sh [-reset_run]\n\
Usage: dithering_tb.sh [-clean]\n\
Usage: dithering_tb.sh [-reset_log]\n\
Usage: dithering_tb.sh [-keep_index]\n\
Usage: dithering_tb.sh [-noclean_files]\n\n\
