...
REM
REM Generated by Vivado on Sat May 23 19:28:02 +0200 2026
...
echo "xvhdl --incr --relax -prj dithering_tb_vhdl.prj"
call xvhdl  --incr --relax -prj dithering_tb_vhdl.prj -log xvhdl.log
