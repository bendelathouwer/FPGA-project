...
REM
REM Generated by Vivado on Sat May 30 18:16:14 +0200 2026
...
echo "xvhdl --incr --relax -prj tb_bitplane_extractor_vhdl.prj"
call xvhdl  --incr --relax -prj tb_bitplane_extractor_vhdl.prj -log xvhdl.log
