...
#
# Script generated by Vivado on Sun May 10 11:16:37 +0200 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : clockdivider_2out_TB.sh
...
#
# Usage        : clockdivider_2out_TB.sh
#                clockdivider_2out_TB.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clockdivider_2out_TB.sh [-rerun]
#                clockdivider_2out_TB.sh [-reset_run]
#                clockdivider_2out_TB.sh [-clean]
#                clockdivider_2out_TB.sh [-reset_log]
#                clockdivider_2out_TB.sh [-help]
#
...
# script info
echo -e "clockdivider_2out_TB.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clockdivider_2out_TB.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xilinx_vip -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot clockdivider_2out_TB xil_defaultlib.clockdivider_2out_TB xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clockdivider_2out_TB -key {Behavioral:sim_1:Functional:clockdivider_2out_TB} -tclbatch cmd.tcl -protoinst "protoinst_files/Processing_System.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb clockdivider_2out_TB.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clockdivider_2out_TB.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clockdivider_2out_TB.sh [-help]\n\
Usage: clockdivider_2out_TB.sh [-step]\n\
Usage: clockdivider_2out_TB.sh [-lib_map_path]\n\
Usage: clockdivider_2out_TB.sh [-rerun]\n\
Usage: clockdivider_2out_TB.sh [-reset_run]\n\
Usage: clockdivider_2out_TB.sh [-clean]\n\
Usage: clockdivider_2out_TB.sh [-reset_log]\n\
Usage: clockdivider_2out_TB.sh [-keep_index]\n\
Usage: clockdivider_2out_TB.sh [-noclean_files]\n\n\
